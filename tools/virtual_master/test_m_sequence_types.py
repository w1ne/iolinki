...
def test_type_1_1():
    ...
    master = VirtualMaster(
        m_seq_type=MSequenceType.TYPE_1_1,
        pd_in_len=2,
        pd_out_len=2
    )
...
def test_type_1_2():
    ...
    # Read ISDU (Vendor ID - Index 0x000A)
...
def test_type_2_1():
    ...
    master = VirtualMaster(
        m_seq_type=MSequenceType.TYPE_2_1,
        pd_in_len=1,
        pd_out_len=1
    )
...
def test_type_2_2():
    ...
    # Read ISDU (Device ID - Index 0x000B)
